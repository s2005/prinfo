...
1. `gh` subprocess decoding is locale-dependent and fragile
...
1. Manifest output does not explain empty exported logs
...
1. Diagnostics are too generic for empty or missing logs
