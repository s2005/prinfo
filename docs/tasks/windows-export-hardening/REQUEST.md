...
1. Robust decoding of downloaded log content
...
1. Clear handling of zero-byte exported logs
...
1. Better user-facing diagnostics
...
- Add or update tests for:
  ...
  1. subprocess output containing problematic bytes
  1. zero-byte exported logs for skipped jobs with clear manifest metadata
